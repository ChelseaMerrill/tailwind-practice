...
function Compute() {
    return (
      <div class="app bg-violet-200">
       ...
       <h1 class="text-3xl font-bold text-center text-indigo-700 mb-10 pt-10">Compute Services</h1>

       
       <div class="grid grid-cols-4 gap-8 max-w-max m-auto">
        {[
            ['Auto Scaling', 'works in conjunction with Cloud Watch to provide predictive scaling based on daily/weekly trends. Components: configuration templates, scaling options, and groups'],
